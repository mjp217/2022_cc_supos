...
let rec translate_expr = function 
    ...
    | If(_, e1, e2, e3) -> Ast.If(translate_expr e1, translate_expr e2, translate_expr e3)
    | While(_, e1, e2) -> Ast.While(List.map translate_expr e1, List.map translate_expr e2)
